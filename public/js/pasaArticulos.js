...
function cargaMateriales(){
    ...
    for (var articulo of Materiales) {
        sku++;
            ...
            $(".tbodyMateriales" ).append( "<tr id="+articulo[0]+"><td>"+sku+"</td><td>"+
            articulo[1]+"</td><td>"+articulo[2]+"</td><td>"+
            articulo[3]+"</td><td><input type=\"text\" class=\"form-control\" placeholder=\"Cantidad\" id=\"cantidadArticulo"+articulo[0]+"\" value="+articulo[7]+" onchange=\"calulaPrecio("+
            articulo[5]+","+articulo[0]+")\"></td><td>"+articulo[6]+"</td><td>"+articulo[5]+"</td><td><input type=\"text\" id=\"margenArticulo"+articulo[0]+"\" class=\"form-control\" placeholder=\"Margen\" value="+articulo[8]+" onchange=\"calulaPrecio("+
            articulo[5]+","+articulo[0]+")\"></td><td><input type=\"text\" class=\"form-control\" placeholder=\"Precio\" id=\"precioArticulo"+articulo[0]+"\" disabled></td>"+
            "<td><input type=\"text\" class=\"form-control\" placeholder=\"IVA\" id=\"ivaArticulo"+articulo[0]+"\" disabled></td>"+
            "<td><input type=\"text\" class=\"form-control\" placeholder=\"PrecioFinal\" id=\"precioFinalArticulo"+articulo[0]+"\" readonly></td>");
