<!-- Modal Dellate Cita para Instalacion -->
<div id="ModalDetallesInstalacion" class="modal fade" role="dialog">
            ...
            <div class="modal-body" style="text-align:left">
                <div class="col-md-12">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <div class="form-group col-xs-6">
                                <label for="txtEncargado" class="col-form-label">Técnico</label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <div class="form-group col-xs-6">
                                <label for="txtCodigoProyecto" class="col-form-label">Código Proyecto</label>
                                <input type="text" class="form-control" id="txtCodigoProyecto" disabled>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <div class="form-group col-xs-6">
                                <label for="txtTipoProyecto" class="col-form-label">Tipo Proyecto</label>
                                <input type="text" class="form-control" id="txtTipoProyecto" disabled>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            <div class="form-group col-xs-6">
                                <label for="txtNroCotizacion" class="col-form-label">Número Cotización</label>
                                <input type="text" class="form-control" id="txtNroCotizacion" disabled>
                            </div>
                        </div>
                    </div>
                    <br />
