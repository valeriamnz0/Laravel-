function fillProvincias() {
    var html = "<option value='' disabled selected>Seleccione una Provincia</option>";
    for (key in provinces) {
        html += "<option value='" + key + "'>" + provinces[key].name + "</option>";
    }
    $('.provincia').html(html);
}
...
function fillCanton(provincia) {
    ...
    var html = "<option value='' disabled selected>Seleccione un Cantón</option>";
    for (key in data) {
...
function nombreProvincia(province, aux) {
    var texto = provinces[province].name;
    $("#" + aux + "texto_provincia").val(texto);
}

function nombreCanton(aux) {
    var texto = $("#" + aux + "canton option:selected").text();
    $("#" + aux + "texto_canton").val(texto);
}

function nombreDistrito(aux) {
    var texto = $("#" + aux + "distrito option:selected").text();
    $("#" + aux + "texto_distrito").val(texto);
}
